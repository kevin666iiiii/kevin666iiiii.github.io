export declare function is<T>(val: T, type: string): boolean;
export declare function isDef<T>(val?: T): val is T;
export declare function isUnDef<T>(val?: T): val is T;
export declare function isObject(val: Object): val is Record<any, any>;
